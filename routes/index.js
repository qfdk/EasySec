...
var baseUrl = 'https://nvd.nist.gov/vuln/search/results?form_type=Basic&results_type=overview&search_type=all&query=';
  ...
  request.get(fullUrl, function (err, response, body) {
    if (!err) {
      ...
      for (var i = 0; i < pages; i++) {
        var tmp = 'https://nvd.nist.gov/vuln/search/results?form_type=Basic&search_type=all&results_type=overview&query=' + cpe + '&startIndex=' + i * 20;
        urls.push(tmp);
      }
      // preparer call
